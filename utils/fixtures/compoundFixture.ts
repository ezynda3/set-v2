...
export class CompoundFixture {
  ...
  public async createAndEnableCToken(
    ...
    // Begin with dummy number
    await this.comptroller._setCollateralFactor(newCToken.address, ether(100));

    // Begin with a dummy price
    await this.priceOracle.setUnderlyingPrice(newCToken.address, ether(1).div(10));
